...
$hasilShear = shear3D($vektorAwalX, $vektorAwalY, $vektorAwalZ, $faktorShearXY,
$faktorShearXZ, $faktorShearYZ);

// Menampilkan hasil shear 3D
echo "Vektor awal sebelum shear: ($vektorAwalX, $vektorAwalY, $vektorAwalZ)\n";
echo "Faktor shear: ($faktorShearXY, $faktorShearXZ, $faktorShearYZ)\n";
echo "Hasil shear: (" . $hasilShear[0] . ", " . $hasilShear[1] . ", " . $hasilShear[2] . ")\n";
?>
