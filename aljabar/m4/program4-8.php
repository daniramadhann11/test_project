...
$hasilTranslasi = translasi($vektorAwalX, $vektorAwalY, $vektorAwalZ, $vektorTranslasiX, $vektorTranslasiY, $vektorTranslasiZ);
...
echo "Hasil translasi: (" . $hasilTranslasi[0] . ", " . $hasilTranslasi[1] . ", " . $hasilTranslasi[2]. ")<br>";
?>
