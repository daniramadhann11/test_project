...
$hasilDilatasi = dilatasi($vektorAwalX, $vektorAwalY, $vektorAwalZ, $faktorSkalaX,
$faktorSkalaY, $faktorSkalaZ);
...
echo "Hasil dilatasi: (" . $hasilDilatasi[0] . ", " . $hasilDilatasi[1] . ", " . $hasilDilatasi[2] ."))<br>";
?>
