...
<label for="a1">Masukkan nilai a1:</label>
<input type="text" name="a1" id="a1" required><br><br>
<label for="b1">Masukkan nilai b1:</label>
<input type="text" name="b1" id="b1" required><br><br>
<label for="c1">Masukkan nilai c1:</label>
<input type="text" name="c1" id="c1" required><br><br>
<label for="a2">Masukkan nilai a2:</label>
<input type="text" name="a2" id="a2" required><br><br>
<label for="b2">Masukkan nilai b2:</label>
<input type="text" name="b2" id="b2" required><br><br>
<label for="c2">Masukkan nilai c2:</label>
<input type="text" name="c2" id="c2" required><br><br>
